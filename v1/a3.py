...
VtoCm = np.log(29.7) / np.log(np.mean(raw_data_width))  # Faktor von V zu cm
zero = np.log(29.7) - (VtoCm * np.log(np.mean(raw_data_width)))  # -> 0
...
print()
print("Length(68%) = " + str(round(y1, 2)) + " cm +- " + str(np.abs(perc_68_l)) + " cm")
print("Length(95%) = " + str(round(y1, 2)) + " cm +- " + str(np.abs(perc_95_l)) + " cm")
print()
print("Width(68%) = " + str(round(y2, 2)) + " cm +- " + str(np.abs(perc_68_w)) + " cm")
print("Width(95%) = " + str(round(y2, 2)) + " cm +- " + str(np.abs(perc_95_w)) + " cm")
print()
